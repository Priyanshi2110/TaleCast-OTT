...
import './Login.css'
import logo from '../../assets/Talle.png'
  ...
  return (
    ...
    <div className='login'>
      ...
      <div className="login-form">
        <h1>{signState}</h1>
        <form>
          {signState==="Sign Up"? <input type="text" value={name} onChange={(e)=>setName
            (e.target.value)} placeholder='Your name'/>:<></>}
        ...
        <div className="form-switch">
          {signState==="Sign In"?
          <p>New To TaleCast? <span onClick={()=>{setSignState("Sign Up")}}>Sign Up Now</span></p>
